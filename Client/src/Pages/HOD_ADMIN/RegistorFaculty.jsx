...
const RegistorFaculty = () => {
  ...
  //   try {
  //     const response = await axiosInstance.post("/user_hod/register_faculty", formData, {
  //       headers: {
  ...
  const handleSubmit = async (event) => {
    ...
    const formData = {
      facultyId: role,  // Assuming `role` is the faculty ID
      name: faculty_name,
      instituteEmail: faculty_email,
      post,
    };
  ...
  return (
    <Layout>
              <h1 class="text-center pt-20 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Register <mark class="px-2 text-white bg-black-600 rounded dark:bg-yellow-500">New Faculty</mark></h1>
