...
const DeleteBatchData = () => {
 ...
 const allBatches=['Y21','Y22','Y23'];
  ...
  return (
    <Layout>
              <h1 className="text-center pt-20 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Delete <mark className="px-2 text-white bg-black-600 rounded dark:bg-yellow-500">DATA</mark></h1>
