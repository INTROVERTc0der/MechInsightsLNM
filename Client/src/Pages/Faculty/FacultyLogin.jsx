...
import { login } from "../../Redux/facultyauthSlice";
...
const FacultyLogin = () => {
  ...
  const handleLogin = async (event) => {
    ...
    if (!loginData.instituteEmail || !loginData.password) {
  ...
  return (
    <Layout>
      <div className="flex items-center justify-center h-[100vh]">
        ...
        >
          <h1 className="text-center text-2xl font-bold">Faculty Login </h1>
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              value={loginData.instituteEmail}
          ...
          <div
            onClick={() =>
              setLoginData({ instituteEmail: "test@gmail.com", password: "Test@123" })
            }
