  ...
  <mark className="text-2xl md:text-7xl lg:text-7xl px-2 text-white bg-black rounded dark:bg-black">LNM</mark>
            ...
            {!isLoggedIn ? (
              <div className="pt-[5rem] flex items-center justify-center space-x-6">
                <Link to="/login">
                  <button className="  px-5 py-3 rounded-md font-semibold text-lg cursor-pointer border-black border-2  hover:bg-yellow-600 transition-all ease-in-out duration-300">
              ...
              <div className="pt-[5rem] flex items-center justify-center space-x-6">
                ...
                <button type="button" className="  px-5 py-3 rounded-md font-semibold text-lg cursor-pointer  border-black border-2  hover:bg-yellow-600 transition-all ease-in-out duration-300">
                  LOGOUT
                  </button>
                </Link>
              </div>
