...
import { changestudentPassword } from "../../Redux/studentauthSlice";
...
const StudentChangePassword = () => {
  ...
  const handleFormSubmit = async (event) => {
    ...
    const res = await dispatch(changestudentPassword(userPassword));
    ...
    if (res.payload.success) navigate("/student/profile");
  };
