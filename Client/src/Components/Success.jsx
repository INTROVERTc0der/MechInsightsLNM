        ...
        <div className="relative p-4 w-full max-w-md h-full md:h-auto">
          ...
          <div className="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <button
              type="button"
              onClick={toggleModal}
              className="w-full text-white bg-yellow-500 hover:bg-yellow-100 transition-all ease-in-out duration-300 rounded-sm py-2 font-semibold text-lg cursor-pointer"
            >
              Continue
            </button>
          </div>
